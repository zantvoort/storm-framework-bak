...
class ORMTemplateImpl implements ORMTemplate {
    ...
    public Query process(@Nonnull StringTemplate stringTemplate) throws PersistenceException {
        return factory.create(new LazyFactoryImpl(factory, tableNameResolver, columnNameResolver, providerFilter), stringTemplate);
    }
    ...
    private List<Column> createColumns(@Nonnull RecordComponent component, boolean primaryKey, boolean autoGenerated) {
        ...
        String columnName;
        Name name = REFLECTION.getAnnotation(component, Name.class);
        if (name != null) {
            columnName = name.value();
        } else if (columnNameResolver != null) {
            columnName = columnNameResolver.resolveColumnName(component);
        } else {
